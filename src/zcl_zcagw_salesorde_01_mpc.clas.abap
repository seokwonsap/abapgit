class ZCL_ZCAGW_SALESORDE_01_MPC definition
  public
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZCAGW_SALESORDE_01_MPC====CP' ##NO_TEXT.
...
CLASS ZCL_ZCAGW_SALESORDE_01_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZCAGW_SALESORDER_SRV_01' ).
...
lo_ref_constraint->add_property( iv_principal_property = 'DocNumber'   iv_dependent_property = 'Vbeln' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZCAGW_SALESORDE_01_MPC=>TS_SALESORDER' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20191025013051'.                  "#EC NOTEXT
...
clear ls_text_element.
ls_text_element-artifact_name          = 'DocNumber'.                 "#EC NOTEXT
