class ZCL_ZCAGW_SALESORDE_02_DPC definition
  public
...
protected section.
  ...
  methods ETSOLISTSET_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_ZCAGW_SALESORDE_02_MPC=>TS_ETSOLIST
    raising
  ...
  methods ETSOLISTSET_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZCAGW_SALESORDE_02_MPC=>TT_ETSOLIST
  ...
  methods ITORDERITEMSSET_CREATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_ZCAGW_SALESORDE_02_MPC=>TS_ITORDERITEMS
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods ITORDERITEMSSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZCAGW_SALESORDE_02_MPC=>TT_ITORDERITEMS
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
...
CLASS ZCL_ZCAGW_SALESORDE_02_DPC IMPLEMENTATION.


  method /IWBEP/IF_MGW_APPL_SRV_RUNTIME~CREATE_ENTITY.
*&----------------------------------------------------------------------------------------------*
*&  Include           /IWBEP/DPC_TEMP_CRT_ENTITY_BASE
*&* This class has been generated on 2019.10.25 11:38:02 in client 400
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_ZCAGW_SALESORDE_02_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA etsolistset_create_entity TYPE zcl_zcagw_salesorde_02_mpc=>ts_etsolist.
 DATA itorderitemsset_create_entity TYPE zcl_zcagw_salesorde_02_mpc=>ts_itorderitems.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA etsolistset_get_entity TYPE zcl_zcagw_salesorde_02_mpc=>ts_etsolist.
 DATA itorderitemsset_get_entity TYPE zcl_zcagw_salesorde_02_mpc=>ts_itorderitems.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_ZCAGW_SALESORDE_02_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA etsolistset_get_entityset TYPE zcl_zcagw_salesorde_02_mpc=>tt_etsolist.
 DATA itorderitemsset_get_entityset TYPE zcl_zcagw_salesorde_02_mpc=>tt_itorderitems.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA etsolistset_update_entity TYPE zcl_zcagw_salesorde_02_mpc=>ts_etsolist.
 DATA itorderitemsset_update_entity TYPE zcl_zcagw_salesorde_02_mpc=>ts_itorderitems.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
...
*  Data declaration
*-------------------------------------------------------------
 DATA i_customer TYPE zif_zca_salesorder_create8=>kunnr.
 DATA i_reqdat TYPE zif_zca_salesorder_create8=>edatu_vbak.
 DATA i_vbeln TYPE zif_zca_salesorder_create8=>vbeln.
 DATA it_orderitems  TYPE zif_zca_salesorder_create8=>zca_in_salesorder_tt.
 DATA t_return  TYPE zif_zca_salesorder_create8=>__bapiret2.
 DATA ls_it_orderitems  TYPE LINE OF zif_zca_salesorder_create8=>zca_in_salesorder_tt.
 DATA ls_t_return  TYPE LINE OF zif_zca_salesorder_create8=>__bapiret2.
 DATA lv_rfc_name TYPE tfdir-funcname.
 DATA lv_destination TYPE rfcdest.
 DATA lv_subrc TYPE syst-subrc.
 DATA lv_exc_msg TYPE /iwbep/mgw_bop_rfc_excep_text.
 DATA lx_root TYPE REF TO cx_root.
DATA ls_request_input_data TYPE zcl_zcagw_salesorde_02_mpc=>ts_etsolist.
...
*  Data declaration
*-------------------------------------------------------------
 DATA i_itmnum TYPE zif_zca_salesorder_getlist9=>posnr.
 DATA i_vbeln TYPE zif_zca_salesorder_getlist9=>vbeln.
 DATA et_so_list  TYPE zif_zca_salesorder_getlist9=>zca_salesorder_tt.
 DATA ls_et_so_list  TYPE LINE OF zif_zca_salesorder_getlist9=>zca_salesorder_tt.
 DATA lv_rfc_name TYPE tfdir-funcname.
 DATA lv_destination TYPE rfcdest.
 DATA lv_subrc TYPE syst-subrc.
 DATA lv_exc_msg TYPE /iwbep/mgw_bop_rfc_excep_text.
...
*-------------------------------------------------------------
 ...
 DATA lv_exc_msg TYPE /iwbep/mgw_bop_rfc_excep_text.
 DATA lx_root TYPE REF TO cx_root.
DATA ls_request_input_data TYPE zcl_zcagw_salesorde_02_mpc=>ts_itorderitems.
DATA ls_entity TYPE REF TO data.
DATA lo_tech_read_request_context TYPE REF TO /iwbep/cl_sb_gen_read_aftr_crt.
DATA ls_key TYPE /iwbep/s_mgw_tech_pair.
DATA lt_keys TYPE /iwbep/t_mgw_tech_pairs.
...
* Map request input fields to function module parameters
       ...
       ls_it_orderitems-itm_number = ls_request_input_data-itm_number.
       ls_it_orderitems-sd_doc = ls_request_input_data-sd_doc.
...
* Create key table for the read operation
         ...
         ls_key-name = 'SD_DOC'.
         ls_key-value = ls_it_orderitems-sd_doc.
         IF ls_key-value IS NOT INITIAL.
         APPEND ls_key TO lt_keys.
         ENDIF.
...
*-------------------------------------------------------------
 DATA i_itmnum TYPE zif_zca_salesorder_getlist9=>posnr.
 DATA i_matnr TYPE zif_zca_salesorder_getlist9=>matnr.
 DATA i_vbeln TYPE zif_zca_salesorder_getlist9=>vbeln.
 DATA et_so_list  TYPE zif_zca_salesorder_getlist9=>zca_salesorder_tt.
 DATA ls_et_so_list  TYPE LINE OF zif_zca_salesorder_getlist9=>zca_salesorder_tt.
 DATA lv_rfc_name TYPE tfdir-funcname.
...
DATA ls_converted_keys LIKE LINE OF et_entityset.
DATA lv_source_entity_set_name TYPE string.
DATA etsolistset_get_entityset TYPE LINE OF zcl_zcagw_salesorde_02_mpc=>tt_etsolist.
DATA ls_filter TYPE /iwbep/s_mgw_select_option.
DATA ls_filter_range TYPE /iwbep/s_cod_select_option.
DATA lr_sd_doc LIKE RANGE OF ls_converted_keys-sd_doc.
DATA ls_sd_doc LIKE LINE OF lr_sd_doc.
...
* Maps key fields to function module parameters
  IF it_key_tab IS NOT INITIAL.
    ...
    IF  lv_source_entity_set_name = 'EtSoListSet'.
      " Convert keys to appropriate entity set structure
      io_tech_request_context->get_converted_source_keys(
        IMPORTING
          es_key_values  = etsolistset_get_entityset ).
       i_itmnum = etsolistset_get_entityset-itm_number.
       i_vbeln = etsolistset_get_entityset-sd_doc.
  ENDIF.
