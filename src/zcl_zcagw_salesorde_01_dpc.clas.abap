class ZCL_ZCAGW_SALESORDE_01_DPC definition
  public
...
protected section.
  ...
  methods ITORDERITEMSSET_CREATE_ENTITY
    importing
    ...
    exporting
      !ER_ENTITY type ZCL_ZCAGW_SALESORDE_01_MPC=>TS_ITORDERITEMS
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods ITORDERITEMSSET_DELETE_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
    ...
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods ITORDERITEMSSET_GET_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
    ...
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods ITORDERITEMSSET_GET_ENTITYSET
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZCAGW_SALESORDE_01_MPC=>TT_ITORDERITEMS
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods ITORDERITEMSSET_UPDATE_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
  ...
  methods SALESORDERSET_CREATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_ZCAGW_SALESORDE_01_MPC=>TS_SALESORDER
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods SALESORDERSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZCAGW_SALESORDE_01_MPC=>TT_SALESORDER
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
...
CLASS ZCL_ZCAGW_SALESORDE_01_DPC IMPLEMENTATION.


  method /IWBEP/IF_MGW_APPL_SRV_RUNTIME~CREATE_ENTITY.
*&----------------------------------------------------------------------------------------------*
*&  Include           /IWBEP/DPC_TEMP_CRT_ENTITY_BASE
*&* This class has been generated on 2019.10.25 10:30:53 in client 400
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_ZCAGW_SALESORDE_01_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA itorderitemsset_create_entity TYPE zcl_zcagw_salesorde_01_mpc=>ts_itorderitems.
 DATA salesorderset_create_entity TYPE zcl_zcagw_salesorde_01_mpc=>ts_salesorder.
...
*-------------------------------------------------------------------------*
*             EntitySet -  ItOrderitemsSet
*-------------------------------------------------------------------------*
     WHEN 'ItOrderitemsSet'.
*     Call the entity set generated method
    itorderitemsset_create_entity(
         EXPORTING iv_entity_name     = iv_entity_name
       	 ...
       	 IMPORTING er_entity          = itorderitemsset_create_entity
    ).
*     Send specific entity data to the caller interfaces
    copy_data_to_ref(
      EXPORTING
        is_data = itorderitemsset_create_entity
      CHANGING
        cr_data = er_entity
   ).
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA itorderitemsset_get_entity TYPE zcl_zcagw_salesorde_01_mpc=>ts_itorderitems.
 DATA salesorderset_get_entity TYPE zcl_zcagw_salesorde_01_mpc=>ts_salesorder.
 DATA lv_entityset_name TYPE string.
...
*     Call the entity set generated method
          itorderitemsset_get_entity(
               EXPORTING iv_entity_name     = iv_entity_name
                         ...
                         it_navigation_path = it_navigation_path
                         io_tech_request_context = io_tech_request_context
             	 IMPORTING er_entity          = itorderitemsset_get_entity
                         es_response_context = es_response_context
          ).

        IF itorderitemsset_get_entity IS NOT INITIAL.
*     Send specific entity data to the caller interface
          copy_data_to_ref(
            EXPORTING
              is_data = itorderitemsset_get_entity
            CHANGING
              cr_data = er_entity
          ).
        ELSE.
...
*&*   generated methods inside the DPC provider subclass - ZCL_ZCAGW_SALESORDE_01_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA itorderitemsset_get_entityset TYPE zcl_zcagw_salesorde_01_mpc=>tt_itorderitems.
 DATA salesorderset_get_entityset TYPE zcl_zcagw_salesorde_01_mpc=>tt_salesorder.
 DATA lv_entityset_name TYPE string.
...
*     Call the entity set generated method
      itorderitemsset_get_entityset(
        EXPORTING
         ...
         io_tech_request_context = io_tech_request_context
       IMPORTING
         et_entityset = itorderitemsset_get_entityset
         es_response_context = es_response_context
       ).
*     Send specific entity data to the caller interface
      copy_data_to_ref(
        EXPORTING
          is_data = itorderitemsset_get_entityset
        CHANGING
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA itorderitemsset_update_entity TYPE zcl_zcagw_salesorde_01_mpc=>ts_itorderitems.
 DATA salesorderset_update_entity TYPE zcl_zcagw_salesorde_01_mpc=>ts_salesorder.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
...
*     Call the entity set generated method
          itorderitemsset_update_entity(
               EXPORTING iv_entity_name     = iv_entity_name
                         ...
                         it_navigation_path = it_navigation_path
                         io_tech_request_context = io_tech_request_context
             	 IMPORTING er_entity          = itorderitemsset_update_entity
          ).
       IF itorderitemsset_update_entity IS NOT INITIAL.
*     Send specific entity data to the caller interface
          copy_data_to_ref(
            EXPORTING
              is_data = itorderitemsset_update_entity
            CHANGING
              cr_data = er_entity
          ).
        ELSE.
...
* Unit test injection
  ...
  method ITORDERITEMSSET_CREATE_ENTITY.
*-------------------------------------------------------------
*  Data declaration
*-------------------------------------------------------------
 DATA i_vbeln TYPE zif_zca_salesorder_create7=>vbeln_va.
 DATA it_orderitems  TYPE zif_zca_salesorder_create7=>zca_in_salesorder_tt.
 DATA t_return  TYPE zif_zca_salesorder_create7=>__bapiret2.
 DATA ls_it_orderitems  TYPE LINE OF zif_zca_salesorder_create7=>zca_in_salesorder_tt.
 DATA ls_t_return  TYPE LINE OF zif_zca_salesorder_create7=>__bapiret2.
 DATA lv_rfc_name TYPE tfdir-funcname.
 DATA lv_destination TYPE rfcdest.
 DATA lv_subrc TYPE syst-subrc.
 DATA lv_exc_msg TYPE /iwbep/mgw_bop_rfc_excep_text.
 DATA lx_root TYPE REF TO cx_root.
DATA ls_request_input_data TYPE zcl_zcagw_salesorde_01_mpc=>ts_itorderitems.
...
* Map request input fields to function module parameters
       i_vbeln = ls_request_input_data-vbeln.
...
* Send the read response to the caller interface
  ...
  method ITORDERITEMSSET_DELETE_ENTITY.
  RAISE EXCEPTION TYPE /iwbep/cx_mgw_not_impl_exc
    EXPORTING
      textid = /iwbep/cx_mgw_not_impl_exc=>method_not_implemented
      method = 'ITORDERITEMSSET_DELETE_ENTITY'.
  ...
  method ITORDERITEMSSET_GET_ENTITY.
*-------------------------------------------------------------
*  Data declaration
*-------------------------------------------------------------
 DATA i_vbeln TYPE zif_zca_salesorder_getlist8=>vbeln.
 DATA et_so_list  TYPE zif_zca_salesorder_getlist8=>zca_salesorder_tt.
 DATA ls_et_so_list  TYPE LINE OF zif_zca_salesorder_getlist8=>zca_salesorder_tt.
 DATA lv_rfc_name TYPE tfdir-funcname.
 DATA lv_destination TYPE rfcdest.
 DATA lv_subrc TYPE syst-subrc.
 DATA lv_exc_msg TYPE /iwbep/mgw_bop_rfc_excep_text.
...
* Maps key fields to function module parameters
    ...
    IF lv_source_entity_set_name = 'ItOrderitemsSet' AND
...
* In GetEntity operation we support only read for the first entry in the response table
      ...
      er_entity-vbeln = ls_et_so_list-sd_doc.
  endmethod.


  method ITORDERITEMSSET_GET_ENTITYSET.
*-------------------------------------------------------------
*  Data declaration
*-------------------------------------------------------------
 DATA i_itmnum TYPE zif_zca_salesorder_getlist8=>posnr.
 DATA i_matnr TYPE zif_zca_salesorder_getlist8=>matnr.
 DATA i_vbeln TYPE zif_zca_salesorder_getlist8=>vbeln.
 DATA et_so_list  TYPE zif_zca_salesorder_getlist8=>zca_salesorder_tt.
 DATA ls_et_so_list  TYPE LINE OF zif_zca_salesorder_getlist8=>zca_salesorder_tt.
 DATA lv_rfc_name TYPE tfdir-funcname.
...
DATA lv_source_entity_set_name TYPE string.
DATA salesorderset_get_entityset TYPE LINE OF zcl_zcagw_salesorde_01_mpc=>tt_salesorder.
  ...
  IF it_key_tab IS NOT INITIAL.
    ...
    IF  lv_source_entity_set_name = 'SalesOrderSet'.
      ...
      io_tech_request_context->get_converted_source_keys(
       ...
       i_vbeln = salesorderset_get_entityset-doc_number.
  ENDIF.
...
*  Only fields that were mapped will be delivered to the response table
 ls_gw_et_so_list-vbeln = ls_et_so_list-sd_doc.
...
ENDLOOP.
  ...
  method ITORDERITEMSSET_UPDATE_ENTITY.
  RAISE EXCEPTION TYPE /iwbep/cx_mgw_not_impl_exc
    EXPORTING
      textid = /iwbep/cx_mgw_not_impl_exc=>method_not_implemented
      method = 'ITORDERITEMSSET_UPDATE_ENTITY'.
...
*-------------------------------------------------------------
 DATA i_vbeln TYPE zif_zca_salesorder_create7=>vbeln_va.
 DATA t_order_partners  TYPE zif_zca_salesorder_create7=>__bapiparnr.
 DATA t_order_schedules_in  TYPE zif_zca_salesorder_create7=>__bapischdl.
 DATA t_return  TYPE zif_zca_salesorder_create7=>__bapiret2.
 DATA ls_t_order_partners  TYPE LINE OF zif_zca_salesorder_create7=>__bapiparnr.
 DATA ls_t_order_schedules_in  TYPE LINE OF zif_zca_salesorder_create7=>__bapischdl.
 DATA ls_t_return  TYPE LINE OF zif_zca_salesorder_create7=>__bapiret2.
 DATA lv_rfc_name TYPE tfdir-funcname.
 DATA lv_destination TYPE rfcdest.
 DATA lv_subrc TYPE syst-subrc.
 DATA lv_exc_msg TYPE /iwbep/mgw_bop_rfc_excep_text.
 DATA lx_root TYPE REF TO cx_root.
DATA ls_request_input_data TYPE zcl_zcagw_salesorde_01_mpc=>ts_salesorder.
DATA ls_entity TYPE REF TO data.
DATA lo_tech_read_request_context TYPE REF TO /iwbep/cl_sb_gen_read_aftr_crt.
DATA ls_key TYPE /iwbep/s_mgw_tech_pair.
DATA lt_keys TYPE /iwbep/t_mgw_tech_pairs.
...
* Map request input fields to function module parameters
       i_vbeln = ls_request_input_data-doc_number.
       ls_t_order_partners-partn_numb = ls_request_input_data-partn_numb.
       ls_t_order_schedules_in-req_date = ls_request_input_data-req_date.

* Append lines of table parameters in the function call
  IF ls_t_order_partners IS NOT INITIAL.
    APPEND ls_t_order_partners TO t_order_partners.
  ENDIF.
  IF ls_t_order_schedules_in IS NOT INITIAL.
    APPEND ls_t_order_schedules_in TO t_order_schedules_in.
  ENDIF.
...
IF lv_destination IS INITIAL OR lv_destination EQ 'NONE'.
  ...
  TRY.
      CALL FUNCTION lv_rfc_name
        ...
        TABLES
          t_return               =   t_return
          t_order_schedules_in   =   t_order_schedules_in
          t_order_partners       =   t_order_partners
        EXCEPTIONS
          system_failure = 1000 message lv_exc_msg
          OTHERS = 1002.
...
READ TABLE t_order_partners INTO ls_t_order_partners INDEX 1.
READ TABLE t_order_schedules_in INTO ls_t_order_schedules_in INDEX 1.
* Create key table for the read operation

        ls_key-name = 'DOC_NUMBER'.
        ls_key-value = i_vbeln.
         IF ls_key-value IS NOT INITIAL.
         APPEND ls_key TO lt_keys.
         ENDIF.
...
* Maps key fields to function module parameters
    ...
    ENDIF.
       ...
       i_vbeln = ls_converted_keys-doc_number.
* Get RFC destination
lo_dp_facade = /iwbep/if_mgw_conv_srv_runtime~get_dp_facade( ).
lv_destination = /iwbep/cl_sb_gen_dpc_rt_util=>get_rfc_destination( io_dp_facade = lo_dp_facade ).
...
* In GetEntity operation we support only read for the first entry in the response table
        ...
        READ TABLE et_so_list INTO ls_et_so_list INDEX 1.
      er_entity-doc_number = ls_et_so_list-sd_doc.
      er_entity-partn_numb = ls_et_so_list-sold_to.
...
*  Data declaration
*-------------------------------------------------------------
 DATA i_customer TYPE zif_zca_salesorder_getlist8=>kunnr.
 DATA i_vbeln TYPE zif_zca_salesorder_getlist8=>vbeln.
 DATA et_so_list  TYPE zif_zca_salesorder_getlist8=>zca_salesorder_tt.
 DATA ls_et_so_list  TYPE LINE OF zif_zca_salesorder_getlist8=>zca_salesorder_tt.
 DATA lv_rfc_name TYPE tfdir-funcname.
...
DATA ls_filter TYPE /iwbep/s_mgw_select_option.
DATA ls_filter_range TYPE /iwbep/s_cod_select_option.
DATA lr_partn_numb LIKE RANGE OF ls_converted_keys-partn_numb.
DATA ls_partn_numb LIKE LINE OF lr_partn_numb.
      ...
      WHEN 'PARTN_NUMB'.
        lo_filter->convert_select_option(
          EXPORTING
            is_select_option = ls_filter
          IMPORTING
            et_select_option = lr_partn_numb ).

        READ TABLE lr_partn_numb INTO ls_partn_numb INDEX 1.
        IF sy-subrc = 0.
          i_customer = ls_partn_numb-low.
        ENDIF.
      WHEN 'DOC_NUMBER'.
        lo_filter->convert_select_option(
          EXPORTING
...
*  Provide the response entries according to the Top and Skip parameters that were provided at runtime
     FROM lv_skip TO lv_top.
*  Only fields that were mapped will be delivered to the response table
 ls_gw_et_so_list-doc_number = ls_et_so_list-sd_doc.
 ls_gw_et_so_list-req_date = ls_et_so_list-req_date.
 ls_gw_et_so_list-partn_numb = ls_et_so_list-sold_to.
APPEND ls_gw_et_so_list TO et_entityset.
CLEAR ls_gw_et_so_list.
ENDLOOP.
