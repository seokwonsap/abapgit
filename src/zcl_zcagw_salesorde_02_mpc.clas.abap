class ZCL_ZCAGW_SALESORDE_02_MPC definition
  public
...
public section.
  ...
  types:
     TS_ETSOLIST type ZCA_SALESORDER_V .
  types:
TT_ETSOLIST type standard table of TS_ETSOLIST .
  types:
  ...
  begin of TS_ITORDERITEMS,
     ...
     REQ_QTY type WMENG,
  end of TS_ITORDERITEMS .
  types:
TT_ITORDERITEMS type standard table of TS_ITORDERITEMS .

  constants GC_ETSOLIST type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'EtSoList' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZCAGW_SALESORDE_02_MPC====CP' ##NO_TEXT.

  methods DEFINE_ETSOLIST
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
...
CLASS ZCL_ZCAGW_SALESORDE_02_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZCAGW_SALESORDER_SRV_02' ).
...
***********************************************************************************************************************************
 ...
 lo_association = model->create_association(
                            ...
                            iv_left_type        = 'EtSoList' "#EC NOTEXT
...
lo_ref_constraint->add_property( iv_principal_property = 'SdDoc'   iv_dependent_property = 'SdDoc' ). "#EC NOTEXT
...
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'ZA_SalesOrderSet'                         "#EC NOTEXT
                                              iv_left_entity_set_name  = 'EtSoListSet'              "#EC NOTEXT
...
* Navigation Properties for entity - EtSoList
lo_entity_type = model->get_entity_type( iv_entity_name = 'EtSoList' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'EtSoList' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZCA_SALESORDER_V'
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'EtSoListSet' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZCAGW_SALESORDE_02_MPC=>TS_ITORDERITEMS' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20191025023756'.                  "#EC NOTEXT
...
ls_text_element-parent_artifact_name   = 'ItOrderitems'.                            "#EC NOTEXT
